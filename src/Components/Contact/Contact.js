      ...
      <div className='pd-y'>
        <div className='contact-content'>
            <div className='section-left'>
                ...
                <div className='section-desc'>I am available for freelance work. Connect with me via phone: <br /> <span>01912-123456</span> or  email:<span> admin@example.com</span></div>
                <form>
